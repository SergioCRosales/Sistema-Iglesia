...
if (!empty($_POST)) {
    ...
    if (empty($_POST['idfeligres'])) {
        ...
        if (is_numeric($idfeligres) and $idfeligres != 0) {
            $query = mysqli_query($conexion, "SELECT * FROM comunionep where idfeligres = '$idfeligres'");
        ...
        if ($result > 0) {
            ...
            $query_insert = mysqli_query($conexion, "INSERT INTO comunionep(partida,folio,libro,fecha,idfeligres,fechabautismo,idmadre,idpadre,idmadrina,idpadrino,idministro,observaciones) values ('$partida', '$folio', '$libro', '$fecha', '$idfeligres', '$fechabautismo', '$idmadre', '$idpadre', '$idmadrina', '$idpadrino', '$idministro', '$observaciones')");
            if ($query_insert) {
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h4 mb-0 text-gray-800">Ingrese datos para constancia de Primera Comunion (Originario de otra parroquia)</h1>
        <a href="lista_primeracomunionep.php" class="btn btn-primary">Ver listado comunion</a>
    </div>

    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <a href="registro_primeracomunion.php" class="btn btn-primary">Originario de esta parroquia</a>
