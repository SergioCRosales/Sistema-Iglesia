...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">Listado de registros de parroquias</h1>
		<a href="registro_parroquia.php" class="btn btn-primary">Nuevo registro</a>
	</div>
			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered" id="table">
					...
					<tbody>
						...
						$query = mysqli_query($conexion, "SELECT * FROM parroquia");
						$result = mysqli_num_rows($query);
						if ($result > 0) {
							while ($data = mysqli_fetch_assoc($query)) { ?>
								<tr>
									<td><?php echo $data['idparroquia']; ?></td>
									...
									<td> 
										<a href="editar_parroquia.php?id=<?php echo $data['idparroquia']; ?>" class="btn btn-success"><i class='fas fa-edit'></i></a>
									</td>
									<td> 
										<form action="eliminar_parroquia.php?id=<?php echo $data['idparroquia']; ?>" method="post" class="confirmar d-inline">
