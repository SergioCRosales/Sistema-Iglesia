...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h4 mb-0 text-gray-800">Listado de registros de testigos (Originarios de otras parroquias)</h1>
		<a href="registro_testigoep.php" class="btn btn-primary">Nuevo registro</a>
	</div>

	<div class="d-sm-flex align-items-center justify-content-between mb-4">
        <a href="lista_testigo.php" class="btn btn-primary">Originario de esta parroquia</a>
    </div>
			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered" id="table">
					...
					<tbody>
						...
						testigoep.idtestigo, 
						feligresesep.nombre as nombretestigo,
						...
						if ($result > 0) {
							while ($data = mysqli_fetch_assoc($query)) { ?>
								<tr>
									...
									<td> 
										<form action="eliminar_testigoep.php?id=<?php echo $data['idtestigo']; ?>" method="post" class="confirmar d-inline">
