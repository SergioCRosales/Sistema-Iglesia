...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">Listado de registros de departamentos</h1>
		<a href="registro_departamento.php" class="btn btn-primary">Nuevo registro</a>
	</div>
						...
						if ($result > 0) {
							while ($data = mysqli_fetch_assoc($query)) { ?>
								<tr>
									...
									<td><?php echo $data['nombredepartamento']; ?></td>
									
									<?php if ($_SESSION['rol'] == 1) { ?>
                                    
									
									<td> 
										<a href="editar_departamento.php?id=<?php echo $data['iddepartamento']; ?>" class="btn btn-success"><i class='fas fa-edit'></i></a>
									</td>
									<td> 
										<form action="eliminar_departamento.php?id=<?php echo $data['iddepartamento']; ?>" method="post" class="confirmar d-inline">
