...
if (!empty($_POST)) {
    ...
    if (empty($_POST['idfeligres'])) {
        ...
        if ($result > 0) {
            ...
            $query_insert = mysqli_query($conexion, "INSERT INTO bautismo(partida,folio,libro,fecha,idfeligres,idmadre,idpadre,idmadrina,idpadrino,idministro,observaciones) values ('$partida', '$folio', '$libro', '$fecha', '$idfeligres', '$idmadre', '$idpadre', '$idmadrina', '$idpadrino', '$idministro', '$observaciones')");
            if ($query_insert) {
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Ingrese datos para constancia de bautismo (Originario de otra parroquia)</h1>
