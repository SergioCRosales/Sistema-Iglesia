...
$pdf->Image('../img/comunion.jpg' , 35 , 20, 30 , 30,'JPG');
$pdf->Cell(18, 10, '', 0);
...
$pdf->Cell(0, 8, 'LISTADO DE PRIMERA COMUNION', 0, 1, 'C');
$pdf->Ln(1);
...
comunion.idcomunion as idcomunion,
...
WHERE comunion.fecha BETWEEN '$desde' AND '$hasta' ORDER BY comunion.fecha,nombre ASC ");
$item = 0;
...
$pdf->Ln();
$pdf->SetFont('Arial', 'B', 11);
$pdf->Cell(0, 8, 'LISTADO DE PRIMERA COMUNION (ORIGINARIOS DE OTRAS PARROQUIAS)', 0, 1, 'C');
$pdf->SetFont('Arial', '', 11);
$pdf->Ln();
