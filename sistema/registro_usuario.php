        ...
        <div class="col-lg-6 m-auto">
            <form action="" method="post" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Ingrese nombre del nuevo usuario" name="nombre" id="nombre"  required pattern="^([A-ZÁÄÉËÍÏÓÖÚÜÑ]{1}[a-záäéëíïóöúüñ]+[ ]?){3,8}$">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" placeholder="Ingrese Usuario" name="usuario" id="usuario"  required pattern="^[a-zA-Z0-9]+"> 
                </div>
                <div class="form-group">
                    <label for="clave">Contraseña</label>
                    <input type="password" class="form-control" placeholder="Ingrese Contraseña" name="clave" id="clave"  required pattern="^[a-zA-Z0-9]+">
                </div>
                <div class="form-group">
                    <label>Rol</label>
