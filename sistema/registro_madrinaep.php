...
if (!empty($_POST)) {
    ...
    if (empty($_POST['idfeligreses'])) {
        ...
        if (is_numeric($idfeligreses) and $idfeligreses != 0) {
            $query = mysqli_query($conexion, "SELECT * FROM madrinaep where idfeligreses = '$idfeligreses'");
            $result = mysqli_fetch_array($query);
        }
        if ($result > 0) {
            $alert = '<div class="alert alert-danger" role="alert">
                                    El registro de la madrina ya existe
                                </div>';
        } else {
            $query_insert = mysqli_query($conexion, "INSERT INTO madrinaep(idfeligreses) values ('$idfeligreses')");
            if ($query_insert) {
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Seleccione datos madrina (Originaria de otra parroquia)</h1>
        <a href="lista_madrinaep.php" class="btn btn-primary">Ver registros madrinas</a>
    </div>

    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <a href="registro_madrina2.php" class="btn btn-primary">Originaria de esta parroquia</a>
        ...
        <div class="col-lg-6 m-auto">
            <form action="" method="post" autocomplete="off">
                ...
                <div class="form-group">
                    <label >Seleccione nombre madrina</label>
                ...
                <input type="submit" value="Añadir a registros madrinas" class="btn btn-primary">
            </form>
        </div>
    </div>
