...
m1.edadesposo as edadesposo,
l.nombrelugar as lugaresposo,
conf.parroquia as parroquiaesposo,
f5.nombre as madreesposo,
f6.nombre as padreesposo,
f2.nombre as nombreesposa,
m1.edadesposa as edadesposa,
l2.nombrelugar as lugaresposa,
conf.parroquia as parroquiaesposa,
f7.nombre as madreesposa,
f8.nombre as padreesposa,
...
JOIN testiga as ta on m1.idtestiga = ta.idtestiga
JOIN feligreses as f3 on ta.idfeligres = f3.idfeligres
JOIN testigo as tso on m1.idtestigo = tso.idtestigo
JOIN feligreses as f4 on tso.idfeligres = f4.idfeligres
JOIN lugar as l on f1.idlugar = l.idlugar
JOIN configuracion as conf on f1.idconfiguracion = conf.idconfiguracion
JOIN madre as md1 on b1.idmadre = md1.idmadre
JOIN feligreses as f5 on md1.idfeligres = f5.idfeligres
JOIN padre as pd1 on b1.idpadre = pd1.idpadre
JOIN feligreses as f6 on pd1.idfeligres = f6.idfeligres
JOIN lugar as l2 on f2.idlugar = l2.idlugar
JOIN madre as md2 on b2.idmadre = md2.idmadre
JOIN feligreses as f7 on md2.idfeligres = f7.idfeligres
JOIN padre as pd2 on b2.idpadre = pd2.idpadre
JOIN feligreses as f8 on pd2.idfeligres = f8.idfeligres
