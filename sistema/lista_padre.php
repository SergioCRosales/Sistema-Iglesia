...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">Listado de registros de padres</h1>
		<a href="registro_padre2.php" class="btn btn-primary">Nuevo registro</a>
	</div>

	<div class="d-sm-flex align-items-center justify-content-between mb-4">
        <a href="lista_padreep.php" class="btn btn-primary">Originaria de otra parroquia</a>
    </div>
			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered" id="table">
					...
					<tbody>
						...
						$query = mysqli_query($conexion, "SELECT padre.idpadre, feligreses.nombre as nombrepadre, feligreses.cui as cui  FROM padre
						...
						if ($result > 0) {
							while ($data = mysqli_fetch_assoc($query)) { ?>
								<tr>
									...
									<td><?php echo $data['nombrepadre']; ?></td>
									...
									<td> 
										<form action="eliminar_padre.php?id=<?php echo $data['idpadre']; ?>" method="post" class="confirmar d-inline">
