...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h4 mb-0 text-gray-800">Listado de registros de padres (Originarios de otras parroquias)</h1>
		<a href="registro_padreep.php" class="btn btn-primary">Nuevo registro</a>
	</div>

	<div class="d-sm-flex align-items-center justify-content-between mb-4">
        <a href="lista_padre.php" class="btn btn-primary">Originario de esta parroquia</a>
    </div>
			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered" id="table">
					...
					<tbody>
						...
						padreep.idpadre, 
						feligresesep.nombre as nombrepadre,
						...
						if ($result > 0) {
							while ($data = mysqli_fetch_assoc($query)) { ?>
								<tr>
									...
									<td> 
										<form action="eliminar_padreep.php?id=<?php echo $data['idpadre']; ?>" method="post" class="confirmar d-inline">
