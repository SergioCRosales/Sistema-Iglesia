...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h4 mb-0 text-gray-800">Listado de registros de madres (Originarias de otras parroquias)</h1>
		<a href="registro_madreep.php" class="btn btn-primary">Nuevo registro</a>
	</div>

	<div class="d-sm-flex align-items-center justify-content-between mb-4">
        <a href="lista_madre.php" class="btn btn-primary">Originaria de esta parroquia</a>
    </div>
    ...
    <a class="col-xl-1 col-md-6 mb-4" >
        ...
        <a class="col-xl-2 col-md-6 mb-4" href="listo_testigoep.php">
			<div class="card border-left-success shadow h-100 py-0">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered" id="table">
					...
					<tbody>
						...
						madreep.idmadre, 
						feligresesep.nombre as nombremadre,
						...
						if ($result > 0) {
							while ($data = mysqli_fetch_assoc($query)) { ?>
								<tr>
									...
									<td> 
										<form action="eliminar_madreep.php?id=<?php echo $data['idmadre']; ?>" method="post" class="confirmar d-inline">
