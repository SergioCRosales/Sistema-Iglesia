...
if (!empty($_POST)) {
    ...
    if (empty($_POST['idbautismo'])) {
        ...
        if (is_numeric($idbautismo) and $idbautismo != 0) {
            $query = mysqli_query($conexion, "SELECT * FROM confirmacion where idbautismo = '$idbautismo'");
        ...
        if ($result > 0) {
            ...
            $query_insert = mysqli_query($conexion, "INSERT INTO confirmacion(partidacf,foliocf,librocf,fecha,idbautismo,idmadrina,idpadrino,idministro,observaciones) values ('$partidacf', '$foliocf', '$librocf', '$fecha', '$idbautismo', '$idmadrina', '$idpadrino', '$idministro', '$observaciones')");
            if ($query_insert) {
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h4 mb-0 text-gray-800">Ingrese datos para constancia de Confirmacion</h1>
        <a href="lista_confirmacion.php" class="btn btn-primary">Ver listado confirmacion</a>
    </div>

    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <a href="registro_confirmacionep.php" class="btn btn-primary">Originario de otra parroquia</a>
        ...
        <div class="col-lg-6 m-auto">
            <form action="" method="post" autocomplete="off">
                ...
                <div class="form-group">
                    ...
                    <input type="number" placeholder="Ingrese numero de partida" name="partidacf" id="partidacf" class="form-control"  required pattern="^[0-9]{10}$">
                </div>
                <div class="form-group">
                    <label for="foliocf">No. Folio</label>
                    <input type="number" placeholder="Ingrese numero de folio" name="foliocf" id="foliocf" class="form-control"  required pattern="^[0-9]{10}$">
                </div>
                <div class="form-group">
                    <label for="librocf">No. Libro</label>
                    <input type="number" placeholder="Ingrese numero de libro" name="librocf" id="librocf" class="form-control"  required pattern="^[0-9]{10}$">
                </div>
                <div class="form-group">
