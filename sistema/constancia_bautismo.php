...
$pdf->Ln();
///pruebas
$pdf->Image('img/bautismo.jpg' , 10 ,8, 25 , 33,'JPG');
$pdf->SetFont('Times', 'B', 20);
$pdf->Cell(0, 8, 'Parroquia '.utf8_decode($data1['parroquia']), 0, 1,'C');
$pdf->SetFont('Times', 'B', 18);
$pdf->Cell(0, 8, utf8_decode($data1['diocesis']), 0, 1,'C');
$pdf->SetFont('Times', 'B', 12);
$pdf->Cell(0, 8, utf8_decode($data1['direccion']), 0, 1,'C');
...
while ($data = mysqli_fetch_assoc($query)) {
	...
	$pdf->Write(8,utf8_decode($data['observaciones']));
    $pdf->SetFont('Arial','',11).
	$pdf->Cell(0, 8, '___________________________________________________________________________', 0, 1,'R');
	$pdf->Cell(0, 8, '___________________________________________________________________________', 0, 1,'R');
	$pdf->Ln(2);
	$pdf->SetFont('Times','',12).
	$pdf->Cell(0,8,utf8_decode('San Lucas Tolimán Sololá, '.fecha()), 0, 1,'C');
	$pdf->Ln(4);
