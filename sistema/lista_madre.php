...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">Listado de registros de madres</h1>
		<a href="registro_madre2.php" class="btn btn-primary">Nuevo registro</a>
	</div>
	
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
        <a href="lista_madreep.php" class="btn btn-primary">Originaria de otra parroquia</a>
    </div>
    ...
    <a class="col-xl-1 col-md-6 mb-4" >
			...
			<div class="card border-left-primary shadow h-100 py-0">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div align='center' class="text-xs font-weight-bold text-primary text-uppercase mb-1"><h6>Ver registros padres</h6></div>
		...
		<a class="col-xl-2 col-md-6 mb-4" href="lista_madrina.php">
			<div class="card border-left-success shadow h-100 py-0">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div class="text-xs font-weight-bold text-success text-uppercase mb-1"><h6>Ver registros madrinas<h6></div>
        ...
        <a class="col-xl-2 col-md-6 mb-4" href="listo_testigo.php">
			<div class="card border-left-success shadow h-100 py-0">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered" id="table">
					...
					<tbody>
						...
						$query = mysqli_query($conexion, "SELECT madre.idmadre, feligreses.nombre as nombremadre, feligreses.cui as cui FROM madre
						...
						if ($result > 0) {
							while ($data = mysqli_fetch_assoc($query)) { ?>
								<tr>
									...
									<td><?php echo $data['nombremadre']; ?></td>
									...
									<td> 
										<form action="eliminar_madre.php?id=<?php echo $data['idmadre']; ?>" method="post" class="confirmar d-inline">
