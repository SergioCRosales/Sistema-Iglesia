...
f4.nombre as madreesposo,
f5.nombre as padreesposo,
f6.nombre as nombreesposa,
m1.edadesposa,
l2.nombrelugar as lugaresposa,
pr.nombreparroquia as parroquiaesposa,
f7.nombre as madreesposa,
f8.nombre as padreesposa,
mnt.nombreministro as ministro,
m1.observaciones
FROM
matrimoniocombh as m1
JOIN testigaep as tgap on m1.idtestiga = tgap.idtestiga
JOIN feligresesep as f1 on tgap.idfeligreses = f1.idfeligres
JOIN testigo as tgo on m1.idtestigo = tgo.idtestigo
JOIN feligreses as f2 on tgo.idfeligres = f2.idfeligres
JOIN bautismo as b on m1.idbautismo = b.idbautismo
JOIN feligreses as f3 on b.idfeligres = f3.idfeligres
JOIN lugar as l on f3.idlugar = l.idlugar
JOIN madre as md on b.idmadre = md.idmadre
JOIN feligreses as f4 on md.idfeligres = f4.idfeligres
JOIN padre as pd on b.idpadre = pd.idpadre
JOIN feligreses as f5 on pd.idfeligres = f5.idfeligres
JOIN feligresesep as f6 on m1.idfeligres = f6.idfeligres
JOIN lugar as l2 on f6.idlugar = l2.idlugar
JOIN parroquia as pr on f6.idparroquia = pr.idparroquia
JOIN padreep as pdp on m1.idpadre = pdp.idpadre
JOIN feligresesep as f7 on pdp.idfeligreses = f7.idfeligres
JOIN madreep as mdp on m1.idmadre = mdp.idmadre
JOIN feligresesep as f8 on mdp.idfeligreses = f8.idfeligres
