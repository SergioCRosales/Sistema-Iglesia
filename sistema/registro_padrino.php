...
if (!empty($_POST)) {
    ...
    if (empty($_POST['nombrepadrino']))  {
        $alert = '<div class="alert alert-danger" role="alert">
                                    Debe ingresar el nombre del padrino
                                </div>';
    } else {
    
        $nombre = $_POST['nombrepadrino'];
        ...
        $sql = "select * from padrino where nombrepadrino='$nombre'";
        ...
        if(mysqli_num_rows($result)>0)
        {
            ...
            $query_insert = mysqli_query($conexion, "INSERT INTO padrino(nombrepadrino) values ('$nombre')");
            if ($query_insert) {
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Ingrese nombre del padrino</h1>
        ...
        <div class="col-lg-6 m-auto">
            <form action="" method="post" autocomplete="off">
                ...
                <br></br>
                    ...
                    <input type="text" placeholder="Ingrese nombre del padrino" name="nombrepadrino" id="nombrepadrino" class="form-control">
                </div>
                

                <input type="submit" value="Guardar registro padrino" class="btn btn-primary">
            </form>
        </div>
    </div>
