...
if (!empty($_POST)) {
    ...
    if (empty($_POST['idfeligres'])) {
        ...
        if (is_numeric($idfeligres) and $idfeligres != 0) {
            $query = mysqli_query($conexion, "SELECT * FROM testiga where idfeligres = '$idfeligres'");
        ...
        if ($result > 0) {
            ...
            $query_insert = mysqli_query($conexion, "INSERT INTO testiga(idfeligres) values ('$idfeligres')");
            if ($query_insert) {
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Seleccione datos testiga</h1>
        <a href="registro_bautismoprueba.php" class="btn btn-primary">Nuevo registro bautismo</a>
    </div>

    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <a href="registro_testigaep.php" class="btn btn-primary">Originaria de otra parroquia</a>
    ...
    <a class="col-xl-1 col-md-6 mb-4" >
        ...
        <a class="col-xl-2 col-md-6 mb-4" href="registro_padrino2.php">
			<div class="card border-left-info shadow h-100 py-0">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
