...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">Listado de registros de madrinas</h1>
		<a href="registro_madrina2.php" class="btn btn-primary">Nuevo registro</a>
	</div>

	<div class="d-sm-flex align-items-center justify-content-between mb-4">
        <a href="lista_madrinaep.php" class="btn btn-primary">Originaria de otra parroquia</a>
    </div>
			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered" id="table">
					...
					<tbody>
						...
						$query = mysqli_query($conexion, "SELECT madrina.idmadrina, feligreses.nombre as nombremadrina, feligreses.cui as cui FROM madrina
						...
						if ($result > 0) {
							while ($data = mysqli_fetch_assoc($query)) { ?>
								<tr>
									...
									<td><?php echo $data['nombremadrina']; ?></td>
									...
									<td> 
										<form action="eliminar_madrina.php?id=<?php echo $data['idmadrina']; ?>" method="post" class="confirmar d-inline">
