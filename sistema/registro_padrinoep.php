...
if (!empty($_POST)) {
    ...
    if (empty($_POST['idfeligreses'])) {
        ...
        if (is_numeric($idfeligreses) and $idfeligreses != 0) {
            $query = mysqli_query($conexion, "SELECT * FROM padrinoep where idfeligreses = '$idfeligreses'");
        ...
        if ($result > 0) {
            ...
            $query_insert = mysqli_query($conexion, "INSERT INTO padrinoep(idfeligreses) values ('$idfeligreses')");
            if ($query_insert) {
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Seleccione datos padrino (Originario de otra parroquia)</h1>
        <a href="lista_padrinoep.php" class="btn btn-primary">Ver registros padrinos</a>
    </div>

    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <a href="registro_padrino2.php" class="btn btn-primary">Originario de esta parroquia</a>
    ...
    <div class="row">
        <div class="col-lg-6 m-auto">
            <form action="" method="post" autocomplete="off">
                ...
                <input type="submit" value="Añadir a registros padrinos" class="btn btn-primary">
            </form>
        </div>
    </div>
