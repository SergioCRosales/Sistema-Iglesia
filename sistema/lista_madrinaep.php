...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h4 mb-0 text-gray-800">Listado de registros de madrinas (Originarias de otras parroquias)</h1>
		<a href="registro_madrinaep.php" class="btn btn-primary">Nuevo registro</a>
	</div>

	<div class="d-sm-flex align-items-center justify-content-between mb-4">
        <a href="lista_madrina.php" class="btn btn-primary">Originaria de esta parroquia</a>
    </div>
			...
			<div class="table-responsive">
				<table class="table table-striped table-bordered" id="table">
					...
					<tbody>
						...
						madrinaep.idmadrina, 
						feligresesep.nombre as nombremadrina,
						...
						if ($result > 0) {
							while ($data = mysqli_fetch_assoc($query)) { ?>
								<tr>
									...
									<td> 
										<form action="eliminar_madrinaep.php?id=<?php echo $data['idmadrina']; ?>" method="post" class="confirmar d-inline">
