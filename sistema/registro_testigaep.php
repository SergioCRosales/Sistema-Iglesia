...
if (!empty($_POST)) {
    ...
    if (empty($_POST['idfeligreses'])) {
        ...
        if (is_numeric($idfeligreses) and $idfeligreses != 0) {
            $query = mysqli_query($conexion, "SELECT * FROM testigaep where idfeligreses = '$idfeligreses'");
            $result = mysqli_fetch_array($query);
        }
        if ($result > 0) {
            $alert = '<div class="alert alert-danger" role="alert">
                                    El registro de la testiga ya existe
                                </div>';
        } else {
            $query_insert = mysqli_query($conexion, "INSERT INTO testigaep(idfeligreses) values ('$idfeligreses')");
            if ($query_insert) {
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Seleccione datos testiga (Originaria de otra parroquia)</h1>
        <a href="lista_testigaep.php" class="btn btn-primary">Ver registros testigas</a>
    </div>

    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <a href="registro_testiga2.php" class="btn btn-primary">Originaria de esta parroquia</a>
        ...
        <div class="col-lg-6 m-auto">
            <form action="" method="post" autocomplete="off">
                ...
                <div class="form-group">
                    <label >Seleccione nombre testiga</label>
                ...
                <input type="submit" value="Añadir a registros de testigas" class="btn btn-primary">
            </form>
        </div>
    </div>
