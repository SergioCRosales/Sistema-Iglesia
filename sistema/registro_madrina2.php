...
if (!empty($_POST)) {
    ...
    if (empty($_POST['idfeligres'])) {
        ...
        if (is_numeric($idfeligres) and $idfeligres != 0) {
            $query = mysqli_query($conexion, "SELECT * FROM madrina where idfeligres = '$idfeligres'");
        ...
        if ($result > 0) {
            ...
            $query_insert = mysqli_query($conexion, "INSERT INTO madrina(idfeligres) values ('$idfeligres')");
            if ($query_insert) {
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Seleccione datos madrina</h1>
        <a href="registro_bautismoprueba.php" class="btn btn-primary">Nuevo registro bautismo</a>
    </div>

    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <a href="registro_madrinaep.php" class="btn btn-primary">Originaria de otra parroquia</a>
