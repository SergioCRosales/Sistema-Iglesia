...
if (!empty($_POST)) {
    ...
    if (empty($_POST['nombredepartamento']))  {
        ...
        $result = 0;
        $sql = "select * from departamento where nombredepartamento='$nombre'";
        ...
        if(mysqli_num_rows($result)>0)
        {
            ...
            $query_insert = mysqli_query($conexion, "INSERT INTO departamento(nombredepartamento) values ('$nombre')");
            if ($query_insert) {
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Ingresar datos nuevo departamento</h1>
        ...
        <div class="col-lg-6 m-auto">
            <form action="" method="post" autocomplete="off">
                ...
                <br></br>
                    ...
                    <input type="text" placeholder="Ingrese nombre de departamento" name="nombredepartamento" id="nombredepartamento" class="form-control">
                </div>
                <br>

                <input type="submit" value="Guardar registro departamento" class="btn btn-primary">
            </form>
        </div>
    </div>
