...
<div class="container-fluid">
	...
	<div class="d-sm-flex align-items-center justify-content-between mb-4">
		<h1 class="h3 mb-0 text-gray-800">Listado de registros de lugares</h1>
		<a href="registro_lugar.php" class="btn btn-primary">Nuevo registro</a>
	</div>
			...
			<div class="card border-left-primary shadow h-100 py-0">
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							<div align='center' class="text-xs font-weight-bold text-primary text-uppercase mb-1"><h5>Listado registros municipios</h5></div>
					...
					<tbody>
						...
						if ($result > 0) {
							while ($data = mysqli_fetch_assoc($query)) { ?>
								<tr>
									<td><?php echo $data['idlugar']; ?></td>
									<td><?php echo $data['nombrelugar']; ?></td>
									
									<?php if ($_SESSION['rol'] == 1) { ?>
                                    
									
									<td> 
										<a href="editar_lugar.php?id=<?php echo $data['idlugar']; ?>" class="btn btn-success"><i class='fas fa-edit'></i></a>
									</td>
									<td> 
										<form action="eliminar_lugar.php?id=<?php echo $data['idlugar']; ?>" method="post" class="confirmar d-inline">
