...
if (!empty($_POST)) {
    ...
    if (empty($_POST['nombrepadre']))  {
        ...
        $sql = "select * from padre where nombrepadre='$nombre'";
        ...
        if(mysqli_num_rows($result)>0)
        {
            ...
            $query_insert = mysqli_query($conexion, "INSERT INTO padre(nombrepadre) values ('$nombre')");
            if ($query_insert) {
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Ingrese nombre del padre</h1>
        ...
        <div class="col-lg-6 m-auto">
            <form action="" method="post" autocomplete="off">
                ...
                <br></br>
                    ...
                    <input type="text" placeholder="Ingrese nombre del padre" name="nombrepadre" id="nombrepadre" class="form-control">
                </div>
                

                <input type="submit" value="Guardar registro padre" class="btn btn-primary">
            </form>
        </div>
    </div>
